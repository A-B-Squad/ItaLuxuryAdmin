...
import { GET_PRODUCTS_BY_SLUG } from "../../../../graph/queries";
...
const UpdateProduct = ({ slug }: { slug: string }) => {
  ...
  useEffect(() => {
    if (!loading && !error && getProductBySlug && getProductBySlug.getProductBySlug) {
      const product = getProductBySlug.getProductBySlug;
