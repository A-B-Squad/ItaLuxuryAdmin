  ...
  return (
    <div className="upload-banner-ads">
      ...
      <div className="flex items-center mb-4 gap-2">
        ...
        <p className="text-gray-400">200PX / 1328PX</p>
      </div>

      <div className="w-full mb-4">
        {localLargeImage ? (
          <div className="h-[200px] w-[960px] relative border-2">
            <Image
              src={localLargeImage}
          ...
          <div className="uppercase shadow-xl flex-col border-dashed text-sm h-[200px] w-[960px] tracking-wider text-gray-500 border rounded-md border-lightBlack flex items-center justify-center text-center bg-gray-200 transition-colors">
            <span>400px / 1328px</span>
