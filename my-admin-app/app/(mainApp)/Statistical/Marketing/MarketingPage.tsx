...
const MarketingPage: React.FC<MarketingPageProps> = ({ dateRange }) => {
          ...
          label: function (context: any) {
            ...
            if (label === "Total Orders") {
              ...
              const count = countDataset
                ...
                : null;
              return `${label}: ${value} TND (${count} orders)`;
            }
            return `${label}: ${value}`;
          },
        },
  ...
  return (
    <div className="MarketingPage w-full flex justify-center gap-2 items-center flex-col">
      <div className="totalOrderByDate w-[800px] bg-gray-50 p-2 border">
      ...
      <div className="totalOrderByStatus w-[800px] bg-gray-50 p-2 border">
