...
const Stats: React.FC = () => {
  ...
  return (
    <div className="bg-gray-100 p-6 rounded-lg shadow-md relative">
      ...
      <div className="w-full mt-4 mb-6 text-sm text-gray-600 border-l-2 rounded px-4 py-2 border-mainColorAdminDash left-3 tracking-wider">
        <p>
          Ces statistiques représentent toutes les commandes, quel que soit leur
          statut.
        </p>
      </div>
