...
import AnimatedCounter from "@/app/Hook/AnimatedCounter";
    ...
    filteredPackages.forEach((pkg) => {
      ...
      if (translatedStatus === "PAYÉ" && pkg.createdAt && pkg.delivredAt) {
        ...
        if (createdAtDate.isValid() && deliveredAtDate.isValid()) {
          ...
          // Calculate profit
          const deliveryCost = 8; // Delivery price
    ...
    <div className="DeliveryPage">
      <div className=" container text-mainColorAdminDash p-5 w-full">
        ...
        <div className="grid grid-cols-3 h-[500px] gap-3">
          ...
          <div className="bg-white shadow-md text-mainColorAdminDash flex items-center justify-center col-span-2 rounded-lg h-full w-full border">
            <Bar
              data={chartData}
              options={{
                responsive: true,
