...
const OrdersPage: React.FC = () => {
  ...
  const exportToPDFPackageList = () => {
    ...
    doc.line(14, 25, 282, 25); // Adjusted line length for landscape
    ...
    autoTable(doc, {
      startY: 46,
      head: [["Réf", "Date de création", "Client", "Phone", "Statut", "Total"]],
      body: [
  ...
  const exportToExcel = () => {
    ...
    XLSX.utils.sheet_add_aoa(
      ws,
      [[null, null, null, null, null, `Total: ${total.toFixed(3)}`]],
      { origin: -1 },
    );
